...
class TestClass(unittest.TestCase):
    ...
    def test_open8_1(self):
        ...
        func.main_logic(actual_df, "open8")

        assert_frame_equal(actual_df, expected_df)

    # 1 2 [e,e,o,o,x]のとき[e,x,o,o,x]にする
    def test_open8_2(self):
        expected_data = {
            0: [e, x, o, o, x],
            1: [e, e, e, e, e],
            2: [e, e, e, e, e],
